...
export class Eval {
	...
	eval_assignment(node, env) {
		...
		if(node.assigne.type == "MEMB") {
			varname = this.eval_obj_member(node.assigne,env,true)
		};
	}
